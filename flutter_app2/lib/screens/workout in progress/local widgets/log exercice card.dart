...
class LogExerciceCard extends StatefulWidget {
  ...
  @override
  State<LogExerciceCard> createState() => _LogExerciceCardState();
}

class _LogExerciceCardState extends State<LogExerciceCard> {
