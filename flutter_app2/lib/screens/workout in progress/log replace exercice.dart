...
import 'local widgets/log replace ex card.dart';

class LogReplaceExercice extends StatefulWidget {
  final String rId;
  final String exId;
  const LogReplaceExercice({super.key, required this.rId, required this.exId});

  @override
  State<LogReplaceExercice> createState() => _LogReplaceExerciceState();
}

class _LogReplaceExerciceState extends State<LogReplaceExercice> {
