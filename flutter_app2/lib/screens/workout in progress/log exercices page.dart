...
import 'local widgets/log exercice card.dart';

class LogExercicesPage extends StatefulWidget {
  final String rId;
  const LogExercicesPage({super.key, required this.rId});

  @override
  State<LogExercicesPage> createState() => _LogExercicesPageState();
}

class _LogExercicesPageState extends State<LogExercicesPage> {
                  ...
                  child: notEmpty == true
                      ? button(
                          ...
                          onPressed: () {
                            ...
                            Map? mapp = userDataMapCopy!["routines"][widget.rId]
                                ["exercices"];
                            ...
                            if (userDataMapCopy!["routines"][widget.rId]
                                    ["exercices"] !=
                                null) {
                              userDataMapCopy!["routines"][widget.rId]
                                      ["exercices"]
                                  .addAll(json.decode(
