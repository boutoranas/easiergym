...
import 'exercice_card_profile.dart';

class ExercicesProfilePage extends StatefulWidget {
  const ExercicesProfilePage({super.key});

  @override
  State<ExercicesProfilePage> createState() => _ExercicesProfilePageState();
}

class _ExercicesProfilePageState extends State<ExercicesProfilePage> {
  //!controllers
  ...
  void initState() {
    ...
    for (var element in exercices) {
      if (InAppData.exercices[element["name"]] == null) {
        defects.add(element["name"]);
      }
    }
