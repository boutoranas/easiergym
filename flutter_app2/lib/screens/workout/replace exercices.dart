...
import 'filter exercices.dart';
import 'local widgets/replace exercice card.dart';

class ReplaceExercices extends StatefulWidget {
  final String rId;
  final String exId;
  const ReplaceExercices({super.key, required this.rId, required this.exId});

  @override
  State<ReplaceExercices> createState() => _ReplaceExercicesState();
}

class _ReplaceExercicesState extends State<ReplaceExercices> {
