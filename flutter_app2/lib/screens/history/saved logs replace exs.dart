...
import 'local widgets/replace saved logs ex card.dart';

class SavedLogsReplaceExs extends StatefulWidget {
  final String lId;
  final String exId;
  const SavedLogsReplaceExs({super.key, required this.lId, required this.exId});

  @override
  State<SavedLogsReplaceExs> createState() => _SavedLogsReplaceExsState();
}

class _SavedLogsReplaceExsState extends State<SavedLogsReplaceExs> {
