...
class ThemeProvider extends ChangeNotifier {
  ThemeMode selectedTheme = DataGestion.theme == 'Default'
      ? ThemeMode.system
      : (DataGestion.theme == 'Light' ? ThemeMode.light : ThemeMode.dark);
...
ThemeData testThemeYellow() {
  return ThemeData(
    ...
    primaryColor: const Color.fromARGB(255, 240, 255, 25),
    scaffoldBackgroundColor: const Color.fromARGB(255, 246, 255, 120),
    cardColor: const Color.fromARGB(255, 191, 201, 58),
    bottomAppBarTheme: const BottomAppBarTheme(
      color: Color.fromARGB(255, 255, 255, 255),
    ),
    dialogTheme: DialogTheme(
